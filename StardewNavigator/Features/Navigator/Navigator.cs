...
namespace StardewNavigator.Features.Navigator
{
    ...
    public class Navigator
    {
        ...
        private void ExecuteCurrentPhaseAStep()
        {
            ...
            int mapW = NavigatorSpatialHelper.GetMapWidth(location);
            int mapH = NavigatorSpatialHelper.GetMapHeight(location);
            ...
            targetTile = NavigatorSpatialHelper.GetNearestPassableTile(
        ...
        public Point TestGetNearestPassableTile(GameLocation location, Point targetTile, int mapW, int mapH)
            => NavigatorSpatialHelper.GetNearestPassableTile(location, targetTile, mapW, mapH);

        public bool TestIsTileCollidingInGame(GameLocation location, int x, int y)
            => NavigatorSpatialHelper.IsTileCollidingInGame(location, x, y);
    }
}
